...
public class EKYCVerifiedCredentialDAO {
    ...
    public void createUserEKYC(String sessionId, String userId, int tenantId, String status, String vc) throws
            UserEKYCException {
    ...
    public EKYCVerifiedCredentialDTO getUserEKYCVC(String sessionId, String userId, int tenantId) throws
            UserEKYCException {
    ...
    public void updateVerifiedCredential(String sessionId, String userId, int tenantId, String vc, String status)
